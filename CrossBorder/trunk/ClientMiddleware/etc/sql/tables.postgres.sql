...
-- DROP DATABASE IF EXISTS airteldb2; 
-- To drop a database you can't be logged into it.
-- CREATE DATABASE airteldb2;
...
\COPY country(uuid,name,countrycode,currency,currencycode,airtelnetwork,countryremitip,countrybalanceip,countryverifyip) FROM '/tmp/Countries.csv' WITH DELIMITER AS '|' CSV HEADER
ALTER TABLE country OWNER TO airtel2;
...
ALTER TABLE accountStatus OWNER TO airtel2;
**/
-- --------------------
-- Table account
-- --------------------
...
\COPY account(uuid, accountStatusUuid, firstName, lastName, username, loginPasswd,apiUsername, apiPasswd, email, phone, creationDate) FROM '/tmp/Accounts.csv' WITH DELIMITER AS '|' CSV HEADER
ALTER TABLE account OWNER TO airtel2;
...
ALTER TABLE sessionlog OWNER TO airtel2;
...
ALTER TABLE clienturl OWNER TO airtel2;
...
ALTER TABLE clientbalance OWNER TO airtel2;
...
ALTER TABLE topup OWNER TO airtel2;
...
ALTER TABLE balancebycountry OWNER TO airtel2;
...
ALTER TABLE topupbycountry OWNER TO airtel2;
**/
-- ---------------------
-- msisdnByCountry
-- ---------------------
...
ALTER TABLE msisdnbycountry OWNER TO airtel2;
/**
-- ==================================
...
ALTER TABLE transactionStatus OWNER TO airtel2;
...
ALTER TABLE transaction OWNER TO airtel2;
...
ALTER TABLE logincount OWNER TO airtel2;
...
ALTER TABLE errorsimulation OWNER TO airtel2;
...
\COPY contact(uuid, name, phone ,email ,network) FROM '/tmp/contact.csv' WITH DELIMITER AS '|' CSV HEADER
ALTER TABLE contact OWNER TO airtel2;**/
