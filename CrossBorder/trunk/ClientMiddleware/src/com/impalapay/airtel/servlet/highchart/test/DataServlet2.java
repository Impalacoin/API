 ...
 */
 ...
 @WebServlet(name="dataServlet2",value="/servlet/highchart/test/dataServlet2")
public class DataServlet2 extends HttpServlet {
    ...
    private List<BrowserShare> getData() {
        ...
        resultList.add(new BrowserShare("Kenya",30.55F));
        resultList.add(new BrowserShare("Nigeria",39.99F));
        resultList.add(new BrowserShare("Rwanda",10.13F));
        resultList.add(new BrowserShare("Burundi",0.49F));
        resultList.add(new BrowserShare("Botswana",6.63F));
        resultList.add(new BrowserShare("Tanzania",7.21F));
        return resultList;
    }
