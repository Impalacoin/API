...
public class APIConstants {
	...
	// mobile subscriber
	public final static String MSISDN_DELIMITER = ";",
			RESPONSE_DELIMITER = ";";

	// Valid values for the parameter "network"
	public final static String[] PARAM_VALID_NETWORKS = { "safaricom",
			"airtel", "orange" };

	// These must match what is in the database table 'SMSC'.
	// They are put in the order of the networks listed above
	public final static String[] PARAM_NETWORK_UUIDS = {
			"bf0b6cd7-9552-4429-a0e3-8a6cd9eb5a31",
			"bf0b6cd7-9552-4429-a0e3-8a6cd9eb5a31",
			"7965cb28-7b54-43b8-97f9-21abac2a06f6" };
	...
	public final static String STATUS_CODE_INSUFFICIENT_BALANCE = "INSUFFICIENT_FLOAT";
