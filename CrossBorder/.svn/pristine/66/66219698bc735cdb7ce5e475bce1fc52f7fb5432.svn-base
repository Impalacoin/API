...
public class ExportPDF extends HttpServlet {
    ...
    final String PDF_TITLE = "Airtel IMT Transactions Summary";
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            populatePDFDocument(statistics, account,
                    context.getRealPath("/images/Airtel.png"));
    ...
    private void populatePDFDocument(SessionStatistics statistics, Account account,
        ...
        try {
            ...
            document.add(addEmptyLine(new Paragraph("This is the total count of transactions requests that have been successful."), 1));
            ...
            document.add(addEmptyLine(new Paragraph("This is the  Total Amount of transaction requests,per country that have been successful.(Amount is in Local Currency)"), 1));
