 ...
 * 
 */
public class TestSessionIdProvider {
	
	//final String CGI_URL = "https://localhost:8443/AirtelRemittance/worldremitsessionid";
	
	//for live
	final String CGI_URL = "https://airtel.tawi.mobi:8454/worldremitsessionid";
	...
	public void testDoPostHttpServletRequestHttpServletResponse() {
		...
		//test for invalid json object
		 assertEquals(getResponse(CGI_URL, "&api_username=demo&api_password=demo"), 
