 ...
 * 
 */
public class TestQueryForex {

	final String CGI_URL = "https://localhost:8443/AirtelRemittance/xchangeRate";
	//final String CGI_URL = "https://airtel.tawi.mobi/xchangeRate";
	/**
	 * Test method for
	 * {@link com.impalapay.airtel.servlet.api.balance.SendMoney#doPost(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)}
	 * .
	 */
	@Test
	public void testDoPostHttpServletRequestHttpServletResponse() {
		...
		user2.put("currency_code", "UNKNOWN_CURRENCY");
		...
		user4.put("session_id", "0f77661b6d0d40118c07002140bde7d6");
		user4.put("currency_code", "KES");
