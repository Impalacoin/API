...
public class TestTransactionStatusDAO {
	...
	final String STATUS2 = "NONREGISTERED_SUBSCRIBER";
	final String TRANSACTION_STATUS_UUID2 = "8a0c25f5-9fb6-48ba-a833-579ff45b73f0";
	final String TRANSACTION_STATUS_DESCRIPTION2 = "not registered on airtel money";
